...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    mineraDataAuthUserSubject.add(
      MineraDataAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MineraDataAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MineraDataAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MineraDataAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    mineraDataAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
MineraDataAuthUser? currentUser;
