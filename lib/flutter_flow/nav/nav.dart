...
class AppStateNotifier extends ChangeNotifier {
  ...
  MineraDataAuthUser? initialUser;
  MineraDataAuthUser? user;
  ...
  void update(MineraDataAuthUser newUser) {
    final shouldUpdate =
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/mineradata-high-resolution-logo-transparent.png',
                    fit: BoxFit.fitWidth,
                  ),
                )
              : page;
